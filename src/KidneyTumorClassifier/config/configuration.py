...
class ConfigurationManager:
    ...
    def get_training_config(self) -> TrainingConfig:
        ...
        params = self.params
        training_data = os.path.join(self.config.data_ingestion.unzip_dir, "kidney-ct-scan-image-latest-new")
    ...
    def get_evaluation_config(self) -> EvaluationConfig:
        eval_config = EvaluationConfig(path_of_model="C:\Resume Projects\Kidney-Tumor-Classifier\\artifacts\\training\\model.h5",
                                       training_data="C:\Resume Projects\Kidney-Tumor-Classifier\\artifacts\\data_ingestion\\kidney-ct-scan-image-latest-new",
